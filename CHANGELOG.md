...
- Rewrote README in English with clearer product positioning and usage guidance.
- Replaced the alias demo dependency with neutral example package names.

## [0.0.3] - 2026-03-06

### Changed

- Updated extension metadata and static assets layout (`icon` moved to `static/`).
- Refined README with demo GIF and simplified sections.
- Added development notes document.
